...
{
public:
    string name = "Kabir Jaipal";
    string rollNo = "23BCA40806";
    string fatherName = "PITHA RAM";
    string enrollmentNo = "22R/18114";
    string motherName = ": KAMLA DEVI";
    int marksBCA106 = 36;
    int marksBCA101 = 10;
    int marksBCA102 = 47;
    int marksBCA103 = 51;
    ...
    int marksBCA109 = 57;
    int marksBCA110 = 66;
    int internalMarksBCA106 = 19; // New internal marks
    int internalMarksBCA101 = 18; // New internal marks
    int internalMarksBCA102 = 18; // New internal marks
    int internalMarksBCA103 = 19; // New internal marks
    int internalMarksBCA104 = 18; // New internal marks
    int internalMarksBCA105 = 19; // New internal marks
    int internalMarksBCA107 = 19; // New internal marks
    int internalMarksBCA108 = 18; // New internal marks
    int internalMarksBCA109 = 19; // New internal marks
    int internalMarksBCA110 = 19; // New internal marks
    ...
    void generateMarkSheet()
    {
        ...
        printLine();
        displaySubjectDetails("BCA 106 ENVIRONMENTAL STUDIES (Theory)", 100, 35, marksBCA106, 0, internalMarksBCA106, marksBCA106 + internalMarksBCA106, true);
        cout << endl;
        displaySubjectDetails("BCA 101 FUNDAMENTALS OF MATHEMATICS (Theory)", 100, 35, marksBCA101, 0, internalMarksBCA101, marksBCA101 + internalMarksBCA101, true);
        displaySubjectDetails("BCA 102 PROGRAMMING WITH C (Theory)", 100, 35, marksBCA102, 0, internalMarksBCA102, marksBCA102 + internalMarksBCA102, true);
        displaySubjectDetails("BCA 103 INTERNET TECHNOLOGY (Theory)", 100, 35, marksBCA103, 0, internalMarksBCA103, marksBCA103 + internalMarksBCA103, true);
        displaySubjectDetails("BCA 104 FUNDAMENTALS OF COMPUTERS (Theory)", 100, 35, marksBCA104, 0, internalMarksBCA104, internalMarksBCA104, true);
        displaySubjectDetails("BCA 105 DIGITAL LOGIC (Theory)", 100, 35, marksBCA105, 0, internalMarksBCA105, internalMarksBCA105, true);
        ...
        displaySubjectDetails("BCA 107 HTML LAB (Practical)", 100, 40, 0, marksBCA107, internalMarksBCA107, marksBCA107 + internalMarksBCA107, false);
        displaySubjectDetails("BCA 108 C PROGRAMMING LAB (Practical)", 100, 40, 0, marksBCA108, internalMarksBCA108, marksBCA108 + internalMarksBCA108, false);
        displaySubjectDetails("BCA 109 MS OFFICE LAB (Practical)", 100, 40, 0, marksBCA109, internalMarksBCA109, marksBCA109 + internalMarksBCA109, false);
        displaySubjectDetails("BCA 110 DIGITAL ELECTRONICS LAB (Practical)", 100, 40, 0, marksBCA110, internalMarksBCA110, marksBCA110 + internalMarksBCA110, false);
        ...
        printLine();
        cout << "\n\033[1mRESULT DECLARE DATE : 09/01/2024\033[0m";
...
private:
    void displaySubjectDetails(const string &subject, int maxMks, int minMks, int theoObt, int pracObt, int internalMarks, int subTotal, bool istheory) const
    {
        int totalObt = istheory ? theoObt : pracObt;
        string status = (totalObt + internalMarks >= minMks) ? "\033[1mPASS\033[0m" : "\033[1mFAIL\033[0m";
